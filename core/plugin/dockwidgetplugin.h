 ...
 */
#ifndef KNIPPTASCH_CORE_DOCKWIDGET_PLUGIN_H
#define KNIPPTASCH_CORE_DOCKWIDGET_PLUGIN_H
...
Q_DECLARE_INTERFACE( Knipptasch::DockWidgetPlugin, "org.kde.Knipptasch.DockWidgetPlugin/0.1" );
