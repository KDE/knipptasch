 ...
 */
#ifndef ACCOUNTGENERALCONFIGPAGE_H
#define ACCOUNTGENERALCONFIGPAGE_H
...
namespace Ui
{
    class AccountGeneralConfigPage;
}
...
class AccountGeneralConfigPage : public AbstractConfigPage
{
    ...
    public:
         ...
         */
        virtual ~AccountGeneralConfigPage();
    ...
    private:
        Ui::AccountGeneralConfigPage *ui;
        Account *m_account;
};
